...
const ComingSoonPage: React.FC = () => {
  ...
  useEffect(() => {
    // Ensure all refs are mounted before running animations
    if (
      !logoRef.current ||
      !glowRef.current ||
      !car1Ref.current ||
    ...
    gsap.set(
      [car1Ref.current, car2Ref.current, car3Ref.current, car4Ref.current],
      {
        opacity: 0,
        scale: 1.3,
        y: 80,
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(32, 223, 105, 0.2) 0%, rgba(32, 223, 105, 0.08) 40%, transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      ...
      <nav className="relative z-50 px-4 sm:px-6 py-4 lg:px-12 lg:py-8">
        <div
          ref={logoRef}
          className="flex items-center justify-between sm:justify-center lg:justify-start"
        >
      ...
      <main className="relative z-10 px-6 lg:px-12 pt-4 lg:pt-8">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 lg:gap-12">
          ...
          <div className="lg:w-1/2 lg:pr-8 text-center lg:text-left">
            ...
            >
              ...
              <span
                ...
                style={{ textShadow: "0 0 40px rgba(32, 223, 105, 0.4)" }}
              >
                LIMITLESS
              </span>
            </h1>
          ...
          <div className="lg:w-1/2 relative h-[320px] sm:h-[450px] lg:h-[600px] mt-4 sm:mt-8 lg:mt-0">
            ...
            >
              <div className="text-[10px] sm:text-xs text-black/50 mb-0.5 font-medium">
                Current Bid
              </div>
              <div className="text-lg sm:text-xl font-black text-primary">
                $245,000
              </div>
              <div className="text-[10px] sm:text-xs text-black/40">
                Porsche 911 GT3
              </div>
            </div>
            ...
            >
              <div className="text-[10px] sm:text-xs text-white/60 mb-0.5 font-medium">
                Sold
              </div>
